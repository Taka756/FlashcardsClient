...
export default {
    ...
    loginClient() {
        ...
        return axios.post('/oauth2/token', payload, {
            ...
            window.localStorage.setItem(ACCESS_TOKEN_KEY, response.data[ACCESS_TOKEN_KEY]);
            window.localStorage.setItem(REFRESH_TOKEN_KEY, response.data[REFRESH_TOKEN_KEY]);
    ...
    refreshToken() {
        ...
        payload.append('refresh_token', window.localStorage.getItem(REFRESH_TOKEN_KEY))
    ...
    getTokenInfo() {
        let payload = new FormData();
        payload.append('token', window.localStorage.getItem(ACCESS_TOKEN_KEY));
